...
read -p $'\e[1;93m[\e[0m\e[1;91m?\e[0m\e[1;93m] Input Username:\e[0m ' username

if [[ -e $username.txt ]]; then
printf "\e[1;93m[\e[0m\e[1;91m*\e[0m\e[1;93m] Removing previous file:\e[0m\e[1;77m %s.txt" $username
rm -rf $username.txt
fi
printf "\n"
